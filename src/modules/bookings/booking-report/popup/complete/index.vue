<template>
  ...
  >
    <el-dialog :visible.sync="ui.dialogFormVisible">
      <p slot="title" style="font-size: 20px;">{{ $t('page.bookingReport.completeReservation') }}</p>
      <div class="content">
        <ul>
          <li>
      ...
      <el-row :gutter="20">
        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
          <el-form-item :label="$t('page.bookingReport.reason')" prop="reasonForComplete">
            <el-input type="textarea"
              maxlength="500"
              show-word-limit
              rows="5"
              v-model="form.reasonForComplete"
      ...
      <div slot="footer">
        ...
        <el-button type="primary" @click="preHandleBeforeSubmit" size="medium" :loading="ui.isSubmiting">{{ $t('page.bookingReport.complete') }}</el-button>
      </div>
    </el-dialog>
</el-form>
</template>
...
export default {
  ...
  methods: {
    ...
    async submit () {
      ...
      try {
        this.form.reasonForComplete = this.form.reasonForComplete.trim()
