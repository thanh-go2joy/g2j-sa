    ...
    <div class="notice-detail-segment" v-loading="ui.isLoadingNoticeDetail">
      <div class="notice-detail-segment__content">
        ...
        <div class="notice-detail-segment__content--line-end">
          ...
          <div class="product-detail-content">
            <p class="render-content-html" v-html="dataDetailNotice.content"></p>
          </div>
        </div>
        <!-- Etart Contentbar-->
      </div>
      <div class="notice-detail-segment__content-q-and-a">
        ...
        <div class="message-content">
          <div class="message-item" v-for="(mess, index) in messageReplied" :key="index">
            <p :class="mess.hotelSn === 1 ? 'content-message-left' : 'content-message-right'">
              {{ mess.content }}
            </p>
            <br />
            <p
              :class="mess.hotelSn === 1 ? 'content-message-left' : 'content-message-right'"
              class="time-right"
            >
              <b>{{ mess.replyName }}</b>
              {{ mess.lastUpdate }}
...
import { getNoticeDetail, getContentReply, onReplyNotice, onDoneNotice } from './api'
...
.notice-detail-segment:deep(.render-content-html) {
  html,
  body,
  div,
  span,
