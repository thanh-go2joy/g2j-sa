  ...
  <sa-section>
    <div class="review-mgt__filter">
      <p class="statistics">
        ...
        <span>&nbsp;{{this.statistics.averageMark}}
            <span v-if="this.statistics.averageMarkFacility">&nbsp;
              ( {{this.statistics.averageMarkFacility}} / {{this.statistics.averageMarkClean}} / {{this.statistics.averageMarkService}} )
            </span>
        </span>
        <br>
        <span style="color: #263a5b">{{$t('page.reviewMgt.number_of_review')}}</span>
    ...
    <div class="review-mgt__table">
      ...
      >
        ...
        >
          <template slot-scope="scope">
            {{ scope.row.numOfLike ? scope.row.numOfLike : 0 }}
          </template>
        </el-table-column>
        <el-table-column
        ...
        >
          <template slot-scope="scope">
            <el-link
              type="primary"
              :href="`/hotel/sadmin/hotel-staff-detail/${scope.row.staffReply.sn}`"
            >
        ...
        <el-table-column
          :label="$t('page.reviewMgt.create_time')"
          :min-width="100"
        >
          <template slot-scope="scope">
        ...
        <el-table-column
          :label="$t('page.reviewMgt.operations')"
          :min-width="100"
        >
          <template slot-scope="scope">
            <el-button
  ...
  methods: {
    ...
    async onShowReview (sn) {
      try {
        ...
        const { data } = await onShowHideReview(sn, json)
