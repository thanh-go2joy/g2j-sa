<template>
  <sa-section class="list-hotel-booting-mgt">
    <template slot="header">
      <div class="list-hotel-booting-mgt__header">
        <el-select
        ...
        <el-select
          ...
          class="action-list filter-search-action"
...
.list-hotel-booting-mgt {
  &__header {
    ...
    .action-list.filter-search-action {
      margin: 0 16px; width: 300px;
      @media (max-width: 480px) {
        margin: 0 !important;
      }
    }
